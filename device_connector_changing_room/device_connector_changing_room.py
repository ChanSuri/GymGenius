...
class DeviceConnector:
    ...
    def publish_data(self, input_data, topic_type): ## errori
        try:
...
if __name__ == '__main__':
    try:
        # with open('C:\\Users\\feder\\OneDrive\\Desktop\\GymGenius\\device_connector_changing_room\\config_device_connector_changing_room.json') as config_file:
        with open('device_connector_changing_room/config_device_connector_changing_room.json') as config_file:
