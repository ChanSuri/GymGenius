...
if __name__ == '__main__':
    try:
        # with open('C:\\Users\\feder\\OneDrive\\Desktop\\GymGenius\\device_connector_entrance\\config_device_connector_entrance.json') as config_file:
        with open('device_connector_entrance/config_device_connector_entrance.json') as config_file:
        ...
        cherrypy.config.update({'server.socket_port': 8094, 'server.socket_host': '0.0.0.0'})
