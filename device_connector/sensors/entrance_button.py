...
# device_id = "EntranceSensor001"  # Replace with your device ID

# # SenML record template for the button
# base_record = {
#     "bn": "GymGenius/Occupancy/Entrance",  # Unique identifier for the button
#     "bt": 0,  # Base time
...
#     record["bt"] = time.time()
#     record["v"] = count
#     with open('entrance_count.senml', 'w') as file:
...
#             print("Entry event sent successfully")
#         else:
