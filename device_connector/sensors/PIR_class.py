...
class SimulatedPIRSensor:
    def __init__(self):
        ...
        self.cardio_machines = ["treadmill", "elliptical_trainer", "stationary_bike"]
        self.lifting_machines = ["rowing_machine", "cable_machine", "leg_press_machine", "smith_machine", "lat_pulldown_machine"]
    ...
    def simulate_usage(self, machine_type="cardio", machines_per_type=1, seconds=0):
        """Simulate usage for a specified type of machines ('cardio' or 'lifting') with a given number of machines per type."""
        # Select machines and room based on the machine type
        ...
        while time.time() < end_time:
            ...
            for machine, machine_index in all_machines:
                ...
                event = self.generate_sensor_data(simulated_value, machine, room, machine_index)
                events.append(event)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Simulated Data for {machine_type.capitalize()} Machines:")
