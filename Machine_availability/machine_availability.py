...
if __name__ == "__main__":
    ...
    # with open('C:\\Users\\feder\\OneDrive\\Desktop\\GymGenius\\Machine_availability\\config_machine_availability.json') as config_file:
    with open('config_machine_availability.json') as config_file:
